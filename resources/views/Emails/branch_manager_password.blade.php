                ...
                <table width="600" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="padding:30px; color:#333333; font-size:16px; line-height:1.6;">
                            <p>تم تفعيل حسابك في <strong>لوحة مدير الفرع</strong> بنجاح.</p>
                            ...
                            <div style="text-align:center; margin:30px 0;">
                                <a href="{{ $loginUrl }}"
                                    style="background-color:#1a73e8; color:#ffffff; text-decoration:none; font-weight:bold; padding:12px 25px; border-radius:6px; display:inline-block;">
                                    تسجيل الدخول
                                </a>
                            </div>
