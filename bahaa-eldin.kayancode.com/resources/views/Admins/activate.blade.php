...
<body>
    <div class="card">
        <h1>تفعيل حساب المشرف</h1>

        <p>أهلاً <strong>{{ $admin->first_name ?? $admin->name }}</strong>، نحتاج منك إدخال رمز التفعيل لإكمال تفعيل
            الحساب.</p>


        <form method="POST" action="{{ route('admin.activate.verify', $admin->uuid) }}">
            @csrf
            <div class="form-row">
